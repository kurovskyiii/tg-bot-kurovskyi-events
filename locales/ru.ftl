...
admin-user-subscribed-for-notifications-message =
  ...
  <b>{ $firstName } { $lastName }</b> 
  <b>@{ $username }</b>
admin-user-sent-new-question =
  <b>Поступил анонимный вопрос! ⁉️</b> 
...
welcome-intro-menu-questions-action-title = Ask: Анонимные вопросы ⁉️
...
questions-intro-message = 
  Помнишь Ask?
   
  Что только мне там не присылали... Было весело, так что я решил возродить его тут! 
   
  Теперь ты можешь задать мне <b>анонимный вопрос</b>, либо что-то просто сказать. Ты получишь мой ответ также через этот бот, я не буду знать, кто отправитель, если ты специально не укажешь это в тексте вопроса. 
   
  Только не признавайся в любви, я итак знаю! 😉♥️
questions-intro-menu-add-question-action-title = Задать анонимный вопрос 🤔
questions-add-message = Введи текст своего вопроса:
questions-verify-message =
  Проверь данные вопроса: 
   
  { $description }
questions-added-message = 
  Отправлено! 🎉 
   
  Скоро ты получишь ответ на свой вопрос, тоже через бот.
questions-income-menu-give-answer-title = Ответить 📝
